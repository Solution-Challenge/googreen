...
class _LoginFreshResetPasswordState extends State<LoginResetPassword> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          backgroundColor: widget.backgroundColor ?? Color(0xFF16c79a),
          centerTitle: true,
          elevation: 0,
          title: Text(
        ...
        children: <Widget>[
          Align(
            ...
            child: Container(
              ...
              color: widget.backgroundColor ?? Color(0xFF16c79a),
              child: Column(
                  ...
                  decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                              color:
                                  widget.backgroundColor ?? Color(0xFF16c79a))),
